<?php
    ...
    $val =  isset( $_POST['titre'] ) and isset( $_POST['auteur'] ) and isset( $_POST['cat'] ) and isset($_POST['stock']) and isset( $_POST['p_ach'] ) and  isset($_POST['desc']) and isset($_FILES['image']) and ($_FILES['image']['error']==0) ;
    ...
    if( $val) {
		...
		if(in_array($ex,$ex_aut) and $p_ach>=1 and $stock>=0){
			...
			add($titre,$auteur,$stock,$cat,$p_ach,$desc,$image);
