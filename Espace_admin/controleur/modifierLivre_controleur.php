<?php
    ...
    //mod le livre
	if(isset($_POST['titre']) and isset( $_POST['auteur'] ) and isset( $_POST['cat'] ) and isset($_POST['dispo']) and isset($_POST['stock']) and isset( $_POST['p_ach'] ) and isset($_POST['desc']) ){
		...
		if(isset($_FILES['image']) and ($_FILES['image']['error']==0)){
			...
			if(in_array($ex,$ex_aut)){
				...
				modifier($_GET['livre'],$titre,$auteur,$dispo,$stock,$cat,$p_ach,$disc,$image);
				header('Location: listeLivres.php');
			}
		}
		else{
			modifier($_GET['livre'],$titre,$auteur,$dispo,$stock,$cat,$p_ach,$disc,$donnees['image']);
